...
const LanguageHeader: React.FC = () => {
  return (
    <div className="flex items-center justify-between lg:p-4 max-md:flex-col max-md:w-full sticky top-0">
      {/* Title */}
      <h1 className="text-lg font-bold text-blue-800 uppercase">
        LANGUAGE STUDENTS ANALYTICS
      </h1>

      {/* Sort and Search */}
      <div className="flex items-center bg-white gap-4 max-md:justify-between max-md:w-full max-md:space-x-2">
        <Button
          className={cn(
