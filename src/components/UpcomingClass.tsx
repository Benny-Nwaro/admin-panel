...
const ClassCard: React.FC<ClassCardProps> = ({
  ...
  const [isReschedule, setIsReschhedule] = useState(true)
  useEffect(()=>{
    joined ? setIsJoin(false): setIsReschhedule(false)
  },[])


  return (
   <div className="flex flex-col space-x-10  bg-white px-6 py-5 rounded-2xl shadow hover:shadow-lg transition-shadow duration-300">
        ...
        <div className="space-y-6">
          {dummyData.map((classData, index) => (
            <ClassCard
              ...
              onJoin={() => alert("Join class clicked")}
